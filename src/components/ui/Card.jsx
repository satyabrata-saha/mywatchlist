...
const DetailsModal = ({ details, onClose }) => {
  ...
  return (
    ...
    >
      <div
        className="relative flex flex-col sm:flex-row gap-6 bg-slate-800/95 backdrop-blur-sm p-6 rounded-lg shadow-2xl max-w-2xl w-full mx-4 border border-slate-100/10 max-h-[90vh]"
